  ...
  return (
    <footer className="bg-foreground text-background py-12 sm:py-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Wrapper con flex para centrar las columnas */}
        <div className="flex justify-center">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-12 mb-8 sm:mb-12 text-center">
            ...
            <div className="space-y-4">
              ...
              {/* Contact info */}
              <div className="flex flex-col items-center gap-2 mt-2 text-xs text-background/70">
