      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-8 sm:gap-16 max-w-6xl mx-auto text-left">
          ...
          <div className="space-y-4 sm:space-y-6 p-6 sm:p-8 bg-muted/30 rounded-2xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed">
              Aspiramos a ser la referencia en instalaciones de la región, reconocidos por la confianza que generamos, la excelencia en cada proyecto y el trato cercano que ofrecemos a nuestros clientes.
            </p>
          </div>
        </div>
      </div>
