  ...
  const values = [
    {
      icon: MessageCircle,
      title: "Diálogo",
      description: "Comunicación constante y transparente en cada etapa del proyecto",
    },
    {
      icon: Shield,
      title: "Honestidad",
      description: "Asesoramiento genuino basado en las necesidades reales",
    },
    {
      icon: Ear,
      title: "Escucha activa",
      description: "Entendemos tus necesidades para ofrecer la mejor solución",
    },
    {
      icon: Zap,
      title: "Agilidad",
      description: "Respuestas rápidas y cumplimiento de plazos acordados",
    },
    {
      icon: Eye,
      title: "Atención al detalle",
      description: "Precisión y cuidado en cada instalación realizada",
    },
    {
      icon: Award,
      title: "Calidad certificada",
      description: "Materiales normados y procesos bajo estándares vigentes",
    },
  ]
    ...
    <section className="py-20 sm:py-28 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 sm:mb-20">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-8 sm:mb-12 text-balance leading-tight px-2">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 max-w-7xl mx-auto">
          {values.map((value, index) => {
            const Icon = value.icon
            return (
              <div
                key={index}
                className="text-center space-y-4 sm:space-y-6 p-6 sm:p-8 hover:bg-muted/30 rounded-xl transition-colors"
              >
